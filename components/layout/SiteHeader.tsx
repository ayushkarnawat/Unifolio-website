...
export function SiteHeader() {
  ...
  return (
    <header
      ref={headerRef}
      className="fixed top-0 inset-x-0 z-50 w-full bg-[#FAF8F5]/95 backdrop-blur-md transition-all py-3.5 shadow-[0_4px_20px_-2px_rgba(28,36,30,0.04)] border-b border-black/[0.06]"
    >
      <div className="mx-auto flex max-w-content items-center justify-between px-6 sm:px-8">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          <Link
            ref={ctaRef}
            href="/get-started"
            className="inline-flex items-center justify-center rounded-full bg-[#22C55E] px-4 sm:px-5 py-2 font-sans text-xs font-semibold text-black border border-black/10 shadow-xs hover:bg-[#16A34A] transition-all active:scale-95"
          >
            Get early access
          </Link>
