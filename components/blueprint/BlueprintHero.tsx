...
export function BlueprintHero() {
  ...
  return (
    <section
      id="hero"
      ref={containerRef}
      className="relative w-full bg-[#FAF8F5] dark:bg-[#000000] select-none min-h-screen transition-colors duration-500"
    >
      ...
      >
        ...
        <div className="relative z-20 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center w-full max-w-7xl mx-auto">
          ...
          >
            ...
            <h2 className="font-sans font-black text-4xl sm:text-5xl md:text-6xl lg:text-[54px] xl:text-[62px] text-[#111613] dark:text-[#FAF8F5] tracking-[-0.04em] uppercase leading-[0.92]">
              SEE THE WHOLE. <br />
              EVERY ASSET. <br />
              ONE VIEW.
            </h2>
          ...
          >
            <div className="relative w-full h-full flex items-center justify-start">
              ...
              <div
                key="glass-card-0"
                className="portfolio-card group/card absolute left-0 w-[240px] sm:w-[270px] md:w-[295px] h-[335px] sm:h-[375px] md:h-[405px] rounded-3xl select-none origin-center overflow-hidden will-change-transform bg-white/95 dark:bg-[#0A0D0B]/95 border border-[#22C55E]/60 dark:border-[#22C55E]/55 shadow-[0_20px_45px_rgba(0,0,0,0.08),0_0_25px_rgba(34,197,94,0.12)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.85),0_0_35px_rgba(34,197,94,0.18),0_0_0_1px_rgba(34,197,94,0.14),inset_0_1px_1px_0_rgba(34,197,94,0.4)] backdrop-blur-2xl flex flex-col justify-between items-center p-6 sm:p-7 cursor-pointer transition-[border-color,box-shadow,background-color] duration-300 ease-out hover:border-[#22C55E]/90 hover:shadow-[0_28px_50px_rgba(0,0,0,0.12),0_0_35px_rgba(34,197,94,0.25)] dark:hover:shadow-[0_28px_60px_rgba(0,0,0,0.95),0_0_35px_rgba(34,197,94,0.28)] hover:z-40"
                style={{ zIndex: 30 }}
              >
                <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-black/[0.03] dark:from-white/[0.08] via-transparent to-transparent" />

                {/* Header Centered */}
                <div className="w-full flex justify-center">
                  <h3 className="font-sans font-bold text-sm sm:text-base text-[#111613] dark:text-white tracking-wide uppercase leading-snug text-center">
                    SCATTERED <br />
                    <span className="text-[#5A685D] dark:text-[#8E9B91] font-medium text-xs sm:text-[13px] tracking-normal capitalize">Fragmented Information</span>
                  </h3>
                </div>
                ...
                <div className="my-auto py-1 flex items-center justify-center relative w-full h-[150px] sm:h-[170px] md:h-[190px]">
                  <div className="relative w-full h-full max-w-[210px] sm:max-w-[230px] max-h-[170px]">
                    <Image
                      ...
                      fill
                      className="object-contain object-center select-none pointer-events-none drop-shadow-[0_10px_25px_rgba(0,0,0,0.45)] dark:drop-shadow-[0_10px_25px_rgba(0,0,0,0.65)]"
              ...
              <div
                key="glass-card-1"
                className="portfolio-card group/card absolute left-0 w-[240px] sm:w-[270px] md:w-[295px] h-[335px] sm:h-[375px] md:h-[405px] rounded-3xl select-none origin-center overflow-hidden will-change-transform bg-white/90 dark:bg-[#0A0C0B]/90 border border-black/[0.08] dark:border-white/[0.22] shadow-[0_20px_45px_rgba(0,0,0,0.06)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.8),0_0_0_1px_rgba(255,255,255,0.05),inset_0_1px_1px_0_rgba(255,255,255,0.22)] backdrop-blur-2xl flex flex-col justify-between items-center p-6 sm:p-7 cursor-pointer transition-[border-color,box-shadow,background-color] duration-300 ease-out hover:border-[#22C55E]/80 hover:shadow-[0_28px_50px_rgba(0,0,0,0.12),0_0_35px_rgba(34,197,94,0.25)] dark:hover:shadow-[0_28px_60px_rgba(0,0,0,0.95),0_0_35px_rgba(34,197,94,0.28)] hover:z-40"
                style={{ zIndex: 26 }}
              >
                <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-black/[0.02] dark:from-white/[0.06] via-transparent to-transparent" />

                {/* Header Centered */}
                <div className="w-full flex justify-center">
                  <h3 className="font-sans font-bold text-sm sm:text-base text-[#111613] dark:text-white tracking-wide uppercase leading-snug text-center">
                    COLLECTED <br />
                    <span className="text-[#5A685D] dark:text-[#8E9B91] font-medium text-xs sm:text-[13px] tracking-normal capitalize">Inward Convergence</span>
                  </h3>
                </div>
              ...
              >
                ...
                <div className="w-full flex justify-center">
                  <h3 className="font-sans font-bold text-sm sm:text-base text-[#111613] dark:text-white tracking-wide uppercase leading-snug text-center">
                    ORGANIZED <br />
                    <span className="text-[#5A685D] dark:text-[#8E9B91] font-medium text-xs sm:text-[13px] tracking-normal capitalize">Structured Strata</span>
                  </h3>
                </div>
              ...
              >
                ...
                <div className="w-full flex justify-center">
                  <h3 className="font-sans font-bold text-sm sm:text-base text-[#111613] dark:text-white tracking-wide uppercase leading-snug text-center">
                    REVEALED <br />
                    <span className="text-[#5A685D] dark:text-[#8E9B91] font-medium text-xs sm:text-[13px] tracking-normal capitalize">Hidden Insights</span>
                  </h3>
                </div>
              ...
              >
                ...
                <div className="w-full flex justify-center">
                  <h3 className="font-sans font-bold text-sm sm:text-base text-[#111613] dark:text-white tracking-wide uppercase leading-snug text-center">
                    CONNECTED <br />
                    <span className="text-[#5A685D] dark:text-[#8E9B91] font-medium text-xs sm:text-[13px] tracking-normal capitalize">Synaptic Network</span>
                  </h3>
                </div>
              ...
              >
                ...
                <div className="w-full flex justify-center">
                  <h3 className="font-sans font-bold text-sm sm:text-base text-[#111613] dark:text-white tracking-wide uppercase leading-snug text-center">
                    CLEAR <br />
                    <span className="text-[#5A685D] dark:text-[#8E9B91] font-medium text-xs sm:text-[13px] tracking-normal capitalize">Unified Clarity</span>
                  </h3>
                </div>
        ...
        <div className="pointer-events-none absolute inset-x-0 bottom-0 h-44 bg-gradient-to-t from-[#FAF8F5] via-[#FAF8F5]/70 dark:from-[#000000] dark:via-[#000000]/70 to-transparent z-30 transition-colors duration-500" />
      </div>
    </section>
  );
}
