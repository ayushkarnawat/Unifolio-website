...
export function BlueprintStackingCards() {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-x-0 top-0 h-44 bg-gradient-to-b from-[#FAF8F5] via-[#FAF8F5]/70 to-transparent z-10" />

      {/* Pinned Fullscreen Stage */}
      <div
        ref={stageRef}
        className="relative h-screen w-full overflow-hidden flex items-center bg-[#FAF8F5]"
      >
        {/* Subtle Horizon Strata */}
        <div className="pointer-events-none absolute inset-x-0 top-1/2 -translate-y-1/2 h-[1px] bg-gradient-to-r from-transparent via-black/[0.04] to-transparent" />
        ...
        >
          ...
          <div className="flex flex-col justify-center shrink-0 pr-12 sm:pr-24 max-w-[580px] sm:max-w-[720px] whitespace-normal">
            <h2 className="font-sans font-extrabold text-5xl sm:text-7xl lg:text-[84px] text-[#111613] tracking-[-0.04em] uppercase leading-[0.92]">
              BUILT TO UNIFY. <br />
          ...
          <div className="flex items-center gap-16 sm:gap-24 shrink-0">
            ...
            <div className="flex flex-col justify-center shrink-0 whitespace-normal max-w-[480px]">
              <h3 className="font-sans font-extrabold text-4xl sm:text-6xl lg:text-7xl text-[#111613] tracking-[-0.035em] uppercase leading-[0.95]">
                ONE VIEW. <br />
                <span className="text-[#5A685D]">NOTHING HIDDEN.</span>
              </h3>
            </div>
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-0 h-36 bg-gradient-to-t from-[#FAF8F5] via-[#FAF8F5]/80 to-transparent z-10" />
    </section>
  );
}
